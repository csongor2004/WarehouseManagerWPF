...
![Entity Framework Core](https://img.shields.io/badge/EF_Core-388E3C?style=for-the-badge&logo=microsoft&logoColor=white)
...
| :---: | :---: |
| <img src="images/checkout.png" width="400"/> | <img src="images/Nyugta.png" width="400"/> |
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/csongor2004/WarehouseManagerWPF.git](https://github.com/csongor2004/WarehouseManagerWPF.git)
